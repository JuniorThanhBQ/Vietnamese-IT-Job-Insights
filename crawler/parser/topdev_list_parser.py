...
class TopDevListParser(BaseParser):
    """
    Parser for TopDev job list pages.
    Extracts job detail URLs from list HTML.
    """

    def __init__(self, html: str, base_url: str = "https://topdev.vn"):
        super().__init__(html)
    ...
    def parse_job_urls(self) -> list[str]:
        ...
        for a_node in self.css("a"):
            ...
            if href and "/detail-jobs/" in href:
